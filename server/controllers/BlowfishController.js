...
module.exports.encrypt = (req, res) => {
    ...
    switch(req.body.type){
        case 'ECB':
            encrypted = bf.encode(req.files[0].buffer, Blowfish.MODE.ECB, Blowfish.PADDING.NULL);
            break;
        case 'CBC':
            encrypted = bf.encode(req.files[0].buffer, Blowfish.MODE.CBC, Blowfish.PADDING.NULL);
            break;
        default:
